...
public class FunctionalityDoctor {
    ...
    public List<Appointment> showAllAppointmentsForCurrentDoctor(Doctor doctor) {
        List<Appointment> appointments = new ArrayList<>();
        for (Appointment appointment : dataConvertor.appointments) {
    ...
    public void printCurrentDoctorAppointments(List<Appointment> appointments) {
        for (int i = 0; i < appointments.size(); i++) {
            System.out.println(appointments.get(i));
        }
    }

    public List<Appointment> sortCurrentDoctorAppointmentsByPatientName(List<Appointment> appointments) {
        return Collections.emptyList();
    }

    public List<Appointment> sortCurrentDoctorAppointmentsByHour(List<Appointment> appointments) {
        return Collections.emptyList();
    }

    public List<Appointment> sortCurrentDoctorAppointmentsByPatientId(List<Appointment> appointments) {
        return Collections.emptyList();
    }
